...
# ---------------------------------------------------------------------------- #
cfg.sched = CN()
#python train.py --config configs/sample.yaml --start_depth 4 --generator_file /media/vxlter/xxx/models/StyleGAN.pytorch/forest2/models/GAN_GEN_SHADOW_3_4.pth
...
cfg.sched.batch_sizes = [256*2, 256, 256, 64, 16, 8, 4, 1, 1]
